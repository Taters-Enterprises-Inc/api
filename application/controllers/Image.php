...
class Image extends CI_Controller {
	...
	public function load_image_influencer($file_name)
	{	
		$file_extension = strtolower(substr(strrchr($file_name,"."),1));
		...
		header('Content-type: ' . $ctype);
		// $url = img_url().$file_name;
		$url = upload_url().'influencer/'.$file_name;
	...
	public function load_influencer_image_contract($file_name)
	{	
		$file_extension = strtolower(substr(strrchr($file_name,"."),1));
		...
		header('Content-type: ' . $ctype);
		$url = upload_url().'influencer_upload_contract/'.$file_name;
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, $url);
		curl_setopt($ch, CURLOPT_HEADER, false);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
