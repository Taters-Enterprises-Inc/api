			...
			case 'GET':
				...
				$response = array(
					"data" => array(
						...
						"inbox" => array(
							'notifications'=> $this->notification_model->getNotifications($user_id, [4,5,6], false, $type),
							"unseen_notifications" => $this->notification_model->getNotifications($user_id, [4,5,6], true, $type),
							'unseen_notifications_count' => $this->notification_model->getUnseenNotificationsCount($user_id, [4,5,6], $type),
						),
					),
