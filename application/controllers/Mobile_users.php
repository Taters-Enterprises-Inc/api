	...
	public function registration()
	{
		switch ($this->input->server("REQUEST_METHOD")) {
			case 'POST':
				...
				$this->form_validation->set_error_delimiters('', '');
				$this->form_validation->set_rules('firstName', 'First Name', 'required|min_length[1]|max_length[20]|trim|alpha');
				$this->form_validation->set_rules('lastName', 'Last Name', 'required|min_length[1]|max_length[20]|trim|alpha');
				$this->form_validation->set_rules('phoneNumber', 'Mobile Number', 'required|is_unique[mobile_users.username]|numeric|max_length[11]|min_length[11]', array(
