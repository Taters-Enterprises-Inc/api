...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info" style="font-size: 1em;">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <strong>Invoice #</strong> <?php echo ($info->invoice_num == '') ? '<span class="badge badge-pill badge-info">Order for confirmation</span>' : $info->invoice_num;?><br>
    ...
    <div class="row">
        <div class="col-12 table-responsive">
            ...
            <?php foreach ($orders as $key => $value): ?>
                    <?php $price = ($value->promo_id == 0) ? $value->price : $value->promo_price;?>
            ...
            <tfoot> 
              ...
              <tr>
                ...
                <td style="text-align: right;"><span>₱</span><span style="padding-left: 70%;"><?php echo number_format(($info->purchase_amount + $distance_fee) - $vdata,2);?></span></td>
              </tr>
              <?php //} else { ?>
                <!-- <tr>
